...
$wg_config_last_updated_date = '12 DEC 2012';    
$storeMduleVersion = "314";
$eCCDesktopCompitableVersion = "v3.0 - 4.5.0.0";
$eCCMobileCompitableVersion = "1.5";
$cartCompitableVersion = "Community Edition 1.2.1 to 1.9.1.0, Enterprise Edition 1.7.1 to 1.13.0.2";
