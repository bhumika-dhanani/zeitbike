...
AJAX;
    ...
    public function extractContent()
    {
        ...
        {
            $this->toggleDebug();
            if (isset($_SESSION) && !isset($_SESSION['amfpc']) &&
                (!isset($_SESSION['amfpc']['blockwasupdated']) || !$_SESSION['amfpc']['blockwasupdated'])){
                $session = new Amasty_Fpc_Model_Session();
                $session->updateBlock('top.links');
                $_SESSION['amfpc']['blockwasupdated'] = true;
            }
