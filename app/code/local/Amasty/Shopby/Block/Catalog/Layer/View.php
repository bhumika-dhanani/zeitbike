    ...
    protected function _afterToHtml($html)
    {
        ...
        foreach ($this->getFilters() as $f){
            ...
            if ($comment){
                ...
                $img = '<i class="amshopby-tooltip-i fa fa-question-circle"><img class="amshopby-tooltip-img  fa fa-question-circle" src="'.$img.'" width="13" height="13" alt="'.htmlspecialchars($comment).'" id="amshopby-img-'.$f->getAttributeCode().'"/></i>';
