...
class Amasty_Shopby_Adminhtml_Amshopby_ValueController extends Mage_Adminhtml_Controller_Action
{
    ...
    public function editAction() 
    {
        ...
        if ($id && !$model->getId()) {
            ...
            $this->_redirect('adminhtml/amshopby_filter/index');
            return;
        }
    ...
    public function saveAction() 
    {
        ...
        if (!$data) {
            ...
            $this->_redirect('adminhtml/amshopby_filter/');
        }
        ...
        try {
            ...
            $this->_redirect('adminhtml/amshopby_filter/edit', array('id'=>$filterId, 'tab'=>'values'));
