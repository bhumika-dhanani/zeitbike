...
class Amasty_Stockstatus_Block_Adminhtml_System_Config_Fieldset_Info
    extends Mage_Adminhtml_Block_System_Config_Form_Fieldset
{
    protected $_contentHtml = '';

    protected $_moduleCode = 'Amasty_Stockstatus';

    protected $_userGuideLink = 'https://amasty.com/docs/doku.php?id=magento_1:custom_stock_status';
