...
CREATE TABLE IF NOT EXISTS {$this->getTable('dropship')} (
      ...
      `fedexsoap_hub_id` INT(6) NULL default NULL COMMENT 'webshopapps dropcommon',
      ...
      `dest_region` text NULL default NULL COMMENT 'webshopapps dropcommon',
      `storepickup_applicable_method` varchar(255) NULL COMMENT 'webshopapps dropship',
