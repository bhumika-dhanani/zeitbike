...
class IWD_OrderManager_Block_System_Config_Form_Fieldset_Runarchive extends Mage_Adminhtml_Block_System_Config_Form_Field
{
    protected function _getElementHtml(Varien_Data_Form_Element_Abstract $element)
    {
        ...
        $archive_link = Mage::helper("adminhtml")->getUrl('adminhtml/sales_archive/archivemanually', array('_secure' => $_secure));
        $restore_link = Mage::helper("adminhtml")->getUrl('adminhtml/sales_archive/restoremanually', array('_secure' => $_secure));
