<?php
class IWD_BirthdayCoupon_Block_System_Config_Form_Fieldset_Extensions extends Mage_Adminhtml_Block_System_Config_Form_Field
{
    protected function _getElementHtml(Varien_Data_Form_Element_Abstract $element)
    {
        $available = Mage::helper('iwd_coupon')->isAvailableVersion();
        $version = Mage::getConfig()->getModuleConfig("IWD_BirthdayCoupon")->version;
