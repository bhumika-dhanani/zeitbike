<?php
class IWD_NewsPopup_Block_System_Config_Form_Fieldset_Extensions extends Mage_Adminhtml_Block_System_Config_Form_Field
{
	...
	{
		$available = Mage::helper('iwdpopup')->isAvailableVersion();
		$version = Mage::getConfig()->getModuleConfig("IWD_NewsPopup")->version;
		if ($available){
