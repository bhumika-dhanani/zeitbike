...
if (! $iwd_av_class) {
	$dropship = Mage::getStoreConfig('sales_email/dropship_order/enabled');
	if(!$dropship) {
		...
		require_once Mage::getModuleDir ( 'controllers', 'Webshopapps_Dropship' ) . DS . 'AjaxController.php';
		class IWD_Opc_Checkout_OnepageController extends Webshopapps_Dropship_AjaxController {
		}
	}
} else {
