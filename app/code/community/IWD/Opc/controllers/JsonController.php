...
//			$data = $this->getRequest()->getPost('shipping_method', '');
	...
	public function commentAction(){
        ...
        Mage::log('data',null,'iwd-cart-data.log');
        Mage::log($cart->getData(),null,'iwd-cart-data.log');
        Mage::log('address',null,'iwd-cart-data.log');
        Mage::log($cart->getBillingAddress()->getData(),null,'iwd-cart-data.log');
