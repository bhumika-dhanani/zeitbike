...
class IWD_Signin_Block_Customer_Account_Dashboard_Info extends Mage_Customer_Block_Account_Dashboard_Info{
    /**
    ...
    protected function _toHtml(){
        $isExtensionEnabled = Mage::getStoreConfigFlag('signin/paypallogin/status');
    ...
    public function getPaypalCustomerEmail()
    {
        ...
        $paypalCustomerData =  Mage::getModel('signin/paypal_customer')->getPaypalCustomerDataByField('customer_id', $customerId);
    ...
    public function getUnlinkUrl(){
        return Mage::getUrl('signin/openidconnect/unlink');
    }
    ...
    public function getAuthLoginUrl(){
        return Mage::getUrl('signin/openidconnect/login');
    }
}
